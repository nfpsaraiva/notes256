...
import { IconCloud, IconLogin, IconLogin2, IconUser } from "@tabler/icons-react";
...
const UserMenu: FC = () => {
  ...
  return (
    <>
      <Menu>
        <Menu.Target>
          <Button size="md" variant="subtle" leftSection={<IconCloud size={20} stroke={2} />} fw={700}>{user.username}</Button>
        </Menu.Target>
        <Menu.Dropdown>
